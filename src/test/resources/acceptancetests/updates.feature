...
Feature: Updates
  ...
  Scenario Outline: A record in FSDR with a device receives an update
    ...
    Examples:
      ...
      | 123456781 | HA-CAR1       | is          | ADECCO | John     | 7DD2611D-F60D-4A17-B759-B021BC5C669A | +447234567890 | England & Wales | Household               | A     | Carlisle  | Area Manager 1 |               |              |
      | 123456782 | HA-CAR1-ZA    | is          | ADECCO | John     | 7DD2611D-F60D-4A17-B759-B021BC5C669A | +447234567890 | England & Wales | Household               | A     | Carlisle  | Area Manager 1 | Team Leader A |              |
      | 123456783 | HA-CAR1-ZA-01 | is not      | ADECCO | John     | 8A2FEF60-9429-465F-B711-83753B234BDD | +447234567890 | England & Wales | Household               | A     | Carlisle  | Area Manager 1 | Team Leader A | 01 Tranche 1 |
      | 123456784 | SA-CAR1-ZA    | is          | ADECCO | John     | 7DD2611D-F60D-4A17-B759-B021BC5C669A | +447234567890 | England & Wales | Communal Establishments | A     | Carlisle  | Area Manager 1 | Team Leader A |              |
      | 123456785 | SA-CAR1-ZA-01 | is not      | ADECCO | John     | 8A2FEF60-9429-465F-B711-83753B234BDD | +447234567890 | England & Wales | Communal Establishments | A     | Carlisle  | Area Manager 1 | Team Leader A | 01 Tranche 1 |
      | 123456786 | CA-RUN1       | is          | ADECCO | John     | 7DD2611D-F60D-4A17-B759-B021BC5C669A | +447234567890 | England & Wales | Census Coverage Survey  | A     | Runnymede | Area Manager 1 |               |              |
      | 123456787 | CA-RUN1-ZA    | is          | ADECCO | John     | 7DD2611D-F60D-4A17-B759-B021BC5C669A | +447234567890 | England & Wales | Census Coverage Survey  | A     | Runnymede | Area Manager 1 | Team Leader A |              |
      | 123456788 | CA-RUN1-ZA-01 | is not      | ADECCO | John     | 8A2FEF60-9429-465F-B711-83753B234BDD | +447234567890 | England & Wales | Census Coverage Survey  | A     | Runnymede | Area Manager 1 | Team Leader A | 01 Tranche 1 |
  ...
  Scenario Outline: A record in FSDR receives a device
    ...
    Examples:
      ...
      | 123456781 | HA-CAR1       | is          | ADECCO | Fransico | +447234567890 | England & Wales | Household               | A     | Carlisle  | Area Manager 1 |               |              |
      | 123456782 | HA-CAR1-ZA    | is          | ADECCO | Fransico | +447234567890 | England & Wales | Household               | A     | Carlisle  | Area Manager 1 | Team Leader A |              |
      | 123456783 | HA-CAR1-ZA-01 | is not      | ADECCO | Fransico | +447234567890 | England & Wales | Household               | A     | Carlisle  | Area Manager 1 | Team Leader A | 01 Tranche 1 |
      | 123456784 | SA-CAR1-ZA    | is          | ADECCO | Fransico | +447234567890 | England & Wales | Communal Establishments | A     | Carlisle  | Area Manager 1 | Team Leader A |              |
      | 123456785 | SA-CAR1-ZA-01 | is not      | ADECCO | Fransico | +447234567890 | England & Wales | Communal Establishments | A     | Carlisle  | Area Manager 1 | Team Leader A | 01 Tranche 1 |
      | 123456786 | CA-RUN1       | is          | ADECCO | Fransico | +447234567890 | England & Wales | Census Coverage Survey  | A     | Runnymede | Area Manager 1 |               |              |
      | 123456787 | CA-RUN1-ZA    | is          | ADECCO | Fransico | +447234567890 | England & Wales | Census Coverage Survey  | A     | Runnymede | Area Manager 1 | Team Leader A |              |
      | 123456788 | CA-RUN1-ZA-01 | is not      | ADECCO | Fransico | +447234567890 | England & Wales | Census Coverage Survey  | A     | Runnymede | Area Manager 1 | Team Leader A | 01 Tranche 1 |
  ...
  Scenario: A record in FSDR receives a replacement chromebook device
    ...
    When the employee "123456781" is sent to all downstream services
    Then the employee "HA-CAR1-ZA-01" is not updated in gsuite
    Then the employee "HA-CAR1-ZA-01" is not updated in ServiceNow
