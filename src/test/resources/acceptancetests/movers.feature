...
Feature: Movers
  ...
  Scenario Outline: A record receives an new Role Id and is correctly moved.
    ...
    Examples:
      ...
      | CAR1          | is          | ADECCO | 7DD2611D-F60D-4A17-B759-B021BC5C669A | CAR2-HA     | Managers     | car2-group,car2-ha-group,household-group,ons_users,ons_drive | N/A                                                |
      | CAR1-HA       | is          | ADECCO | 8A2FEF60-9429-465F-B711-83753B234BDD | CAR2-HA-01  | EW-Officers  | car2-ha-group,household-group,ons_users,ons_drive            | car1-group                                         |
      | CAR1-HA-01    | is          | ADECCO | 7DD2611D-F60D-4A17-B759-B021BC5C669A | CAR2        | Managers     | car2-group,household-group,ons_users                         | car1-ha-group,ons_drive                            |
      | CAR1          | is          | ADECCO | 8A2FEF60-9429-465F-B711-83753B234BDD | CAR2-HA-01  | EW-Officers  | car2-ha-group,household-group,ons_users,ons_drive            | car1-group                                         |
      | CAR1-HA       | is          | ADECCO | 7DD2611D-F60D-4A17-B759-B021BC5C669A | CAR2        | Managers     | car2-group,household-group,ons_users                         | car1-ha-group,ons_drive                            |
      | CAR1-HA-01    | is          | ADECCO | 7DD2611D-F60D-4A17-B759-B021BC5C669A | CAR2-HA     | Managers     | car2-group,car2-ha-group,household-group,ons_users,ons_drive | N/A                                                |