...
Feature: Creates
  ...
  Scenario Outline: A record is created in the downstream systems
    ...
    Examples:
      ...
      | 100000004 | cr1004 | SA-RNE1-ZA    | is          | ADECCO | 7DD2611D-F60D-4A17-B759-B021BC5C669A | England & Wales | Communal Establishments | A     | North East  | Area Manager 1 | Team Leader A |              |
      | 100000005 | cr1005 | SA-RNE1-ZA-01 | is not      | ADECCO | 8A2FEF60-9429-465F-B711-83753B234BDD | England & Wales | Communal Establishments | A     | North East  | Area Manager 1 | Team Leader A | 01 Tranche 1 |
