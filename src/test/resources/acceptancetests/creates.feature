...
Feature: Creates
  ...
  Scenario Outline: A record is created in the downstream systems
    ...
    And we ingest managers of "<role_id>"
    And we ingest them
  ...
  Examples:
    ...
    #| 123456781 | HA-CAR1       | is          | ADECCO | 7DD2611D-F60D-4A17-B759-B021BC5C669A | Zero Access | ons_users  | England & Wales | Household               | A     | Carlisle  | Area Manager 1 |               |              |
    | 123456782 | HA-CAR1-ZA    | is          | ADECCO | 7DD2611D-F60D-4A17-B759-B021BC5C669A | Zero Access | ons_users  | England & Wales | Household               | A     | Carlisle  | Area Manager 1 | Team Leader A |              |
#    | 123456783 | HA-CAR1-ZA-01 | is not      | ADECCO | 8A2FEF60-9429-465F-B711-83753B234BDD | Zero Access | ons_users  | England & Wales | Household               | A     | Carlisle  | Area Manager 1 | Team Leader A | 01 Tranche 1 |
#    | 123456784 | SA-CAR1-ZA    | is          | ADECCO | 7DD2611D-F60D-4A17-B759-B021BC5C669A | Zero Access | ons_users  | England & Wales | Communal Establishments | A     | Carlisle  | Area Manager 1 | Team Leader A |              |
#    | 123456785 | SA-CAR1-ZA-01 | is not      | ADECCO | 8A2FEF60-9429-465F-B711-83753B234BDD | Zero Access | ons_users  | England & Wales | Communal Establishments | A     | Carlisle  | Area Manager 1 | Team Leader A | 01 Tranche 1 |
#    | 123456786 | CA-RUN1       | is          | ADECCO | 7DD2611D-F60D-4A17-B759-B021BC5C669A | Zero Access | ons_users  | England & Wales | Census Coverage Survey  | A     | Runnymede | Area Manager 1 |               |              |
#    | 123456787 | CA-RUN1-ZA    | is          | ADECCO | 7DD2611D-F60D-4A17-B759-B021BC5C669A | Zero Access | ons_users  | England & Wales | Census Coverage Survey  | A     | Runnymede | Area Manager 1 | Team Leader A |              |
#    | 123456788 | CA-RUN1-ZA-01 | is not      | ADECCO | 8A2FEF60-9429-465F-B711-83753B234BDD | Zero Access | ons_users  | England & Wales | Census Coverage Survey  | A     | Runnymede | Area Manager 1 | Team Leader A | 01 Tranche 1 |
