  ...
  public void the_employee_with_roleId_is_correctly_updated_in_XMA(String source, String roleId, String group) {
    ...
    assertThat(records[0]).contains(
        "{\"className\":\"System.EndUser\",\"formValues\":[{\"name\":\"_BadgeNumber\",\"value\":null},{\"name\":\"_EmploymentStatus\",\"value\":\"ACTIVE\"},{\"name\":\"_FirstName\",\"value\":"
            + "\"Fransico\"},{");
    assertThat(records[0]).containsPattern("\"name\":\"_ContractStartDate\",\"value\":\"[0-9-]{10}");
    assertThat(records[0]).contains("\"},{\"name\":\"_ContractEndDate\",\"value\":\"" + LocalDate.now().plusDays(5)
        + "\"},{\"name\":\"_JobRole\",\"value\":null},{\"name\":\"_LineManagerString\",\"value\":\"null null\"},{\"name\":\"_LocationString\",\"value\":\"London\"},{\"name\":\"_RoleID\",\"value\":\""
        + roleId + "\"},{\"name\":\"CurrentGroup\",\"value\":\"" + group
        + "\"},{\"name\":\"PrimaryGroup\",\"value\":\"" + group + "\"},{");
    assertThat(records[0]).containsPattern("\"name\":\"Name\",\"value\":\"Fransico.Buyo[0-9]{2}@domain\"");
    assertThat(records[0])
        .contains("},{\"name\":\"_PreferredName\",\"value\":null},{\"name\":\"_UserOrg\",\"value\":\"" + source
            + "\"},{\"name\":\"_Surname\",\"value\":\"Buyo\"},{");
    assertThat(records[0]).containsPattern("\"name\":\"EMailAddress\",\"value\":\"Fransico.Buyo[0-9]{2}@domain\"");
    assertThat(records[0]).contains(
